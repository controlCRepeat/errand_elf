...
Intent detection and natural language parsing is handled by Gemini 1.5 Flash. Data is stored in PostgreSQL via Supabase.
...
├── ai.py           # Gemini API call and intent parsing
